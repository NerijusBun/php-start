...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header('Location: http://localhost/php-start/HomeWork/web-mechanika/u9.php');
    die;
...
<h2><a href="http://localhost/php-start/HomeWork/web-mechanika/u9.php">GO TO CHECK AGAIN</a></h2>
</div>
<?php endif ?>
